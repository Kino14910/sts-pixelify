...
declare module "godot" {
    ...
    class ShaderEditor<Map extends Record<string, Node> = Record<string, Node>> extends Control<Map> {
        constructor(identifier?: any)
    }
    ...
    class ShaderTextEditor<Map extends Record<string, Node> = Record<string, Node>> extends CodeTextEditor<Map> {
        constructor(identifier?: any)
        readonly script_validated: Signal1<boolean>
    }
