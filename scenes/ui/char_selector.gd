...
const IRONCLAD = preload('res://characters/Ironclad.tres')
const SILENCE_HUNTER = preload('res://characters/SilenceHunter.tres')
const WIZARD = preload('res://characters/Wizard.tres')
