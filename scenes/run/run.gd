...
func _ready() -> void:
	...
	match run_startup.type:
		RunStartup.Type.NEW_RUN:
			character = run_startup.picked_character.instantiate()
			_start_run()
...
func _setup_event_connections() -> void:
	Events.battle_won.connect(_change_view.bind(CAMPFIRE_SCENE))
	...
	Events.event_room_exited.connect(_change_view.bind(BATTLE_SCENE))
